...
var InsertImageInputSet = function() {
    InsertImageInputSet.super_.call(this);
        /*
        Set the value of the ImageResource input for this Choreo. ((required, json) A JSON string containing the image resorce fields to set. Required properties include: name, preferredKernel, rawDisk.source, and sourceType.)
        */
