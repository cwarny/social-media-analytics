...
var DeleteZoneOperationInputSet = function() {
    DeleteZoneOperationInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Zone input for this Choreo. ((required, string) The name of the zone associated with the operation being deleted.  (e.g. europe-west1-b))
        */
...
var GetZoneOperationInputSet = function() {
    GetZoneOperationInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Zone input for this Choreo. ((required, string) The name of the zone associated with the operation being retrieved.  (e.g. europe-west1-b))
        */
        this.set_Zone = function(value) {
            this.setInput("Zone", value);
        }
...
var ListZoneOperationsInputSet = function() {
    ListZoneOperationsInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Zone input for this Choreo. ((required, string) The name of the zone that contains the operation resources to retrieve.  (e.g. europe-west1-b))
        */
        this.set_Zone = function(value) {
            this.setInput("Zone", value);
        }
