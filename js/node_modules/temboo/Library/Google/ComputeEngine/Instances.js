...
var AddAccessConfigInputSet = function() {
    AddAccessConfigInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Zone input for this Choreo. ((required, string) The name of the zone associated with this request.  (e.g. europe-west1-b))
        */
...
var AttachDiskInputSet = function() {
    AttachDiskInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the DeviceName input for this Choreo. ((optional, string) The name of the disk to attach.)
        */
...
var InsertInstanceInputSet = function() {
    InsertInstanceInputSet.super_.call(this);
        /*
        Set the value of the InstanceResource input for this Choreo. ((required, json) A JSON string containing the instance resource fields to set. See documentation for a list of required properties that should be included.)
        */
        ...
        */
        ...
        /*
        Set the value of the Zone input for this Choreo. ((optional, string) The name of the zone associated with this request.  (e.g. europe-west1-b))
        */
        this.set_Zone = function(value) {
            this.setInput("Zone", value);
        }
...
var SetMetadataInputSet = function() {
    SetMetadataInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Fingerprint input for this Choreo. ((required, integer) The current fingerprint of this resource. You must provide the current version of the fingerprint to successfully update any metadata.)
        */
...
var SetTagsInputSet = function() {
    SetTagsInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Fingerprint input for this Choreo. ((required, integer) The current fingerprint of this resource. You must provide the current version of the fingerprint to successfully update tags.)
        */
        this.set_Fingerprint = function(value) {
            this.setInput("Fingerprint", value);
        }
