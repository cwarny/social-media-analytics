...
var GetMachineTypeInputSet = function() {
    GetMachineTypeInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Zone input for this Choreo. ((required, string) The name of the zone that contains the machine type to retrieve.  (e.g. europe-west1-b))
        */
...
var ListMachineTypesInputSet = function() {
    ListMachineTypesInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Zone input for this Choreo. ((required, string) The name of the zone that contains the machine type resources to retrieve.  (e.g. europe-west1-b))
        */
        this.set_Zone = function(value) {
            this.setInput("Zone", value);
        }
