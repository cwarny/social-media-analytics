...
var CreateDBInstanceInputSet = function() {
    CreateDBInstanceInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the DBInstanceClass input for this Choreo. ((required, string) Capacity for the DB instance.  (db.m1.micro , db.m1.small, db.m1.large, db.m1.xlarge, db.m2.xlarge, db.m2.2xlarge, or db.m2.4xlarge).)
        */
