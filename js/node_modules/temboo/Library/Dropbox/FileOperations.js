...
var CopyFileOrFolderResultSet = function(resultStream) {
    ...
    */
    this.getItemMetadata = function()  {
    	return new  DropboxItemMetadata(JSON.parse(this.getResult('Response')));
    }
}
...
var ZipFolderResultSet = function(resultStream) {
    ...
    */
    this.getFolderContentsList = function()  {
    	return new  DropboxFolderContentsList(JSON.parse(this.getResult('Response')));
    }
}
