...
var FedExLocatorRequest = function(session) {
    /*
        Create a new instance of the FedExLocatorRequest Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/FedEx/FedExLocatorRequest"
    FedExLocatorRequest.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new FedExLocatorRequestResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new FedExLocatorRequestInputSet();
    }
...
var FedExLocatorRequestInputSet = function() {
    FedExLocatorRequestInputSet.super_.call(this);
        /*
        Set the value of the AccountNumber input for this Choreo. ((required, string) Your FedEx Account Number)
        */
        this.set_AccountNumber = function(value) {
        ...
        */
        this.set_StateOrProvinceCode = function(value) {
            this.setInput("StateOrProvinceCode", value);
        }
...
var FedExLocatorRequestResultSet = function(resultStream) {
    FedExLocatorRequestResultSet.super_.call(this, resultStream);    
        /*
        ...
        */
        this.get_BusinessAddress = function() {
            return this.getResult("BusinessAddress");
        }
        /*
        ...
        */
        this.get_BusinessName = function() {
            return this.getResult("BusinessName");
        }
        /*
        Retrieve the value for the "Response" output from this Choreo execution. ((xml) The response from FedEx)
        */
...
util.inherits(FedExLocatorRequest, choreography.Choreography);
util.inherits(FedExLocatorRequestInputSet, choreography.InputSet);
util.inherits(FedExLocatorRequestResultSet, choreography.ResultSet);
exports.FedExLocatorRequest = FedExLocatorRequest;
