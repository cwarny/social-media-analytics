...
var QueryArticlesResultSet = function(resultStream) {
    ...
    */
    this.getOffset = function()  {
    	return JSON.parse(this.getResult('Response'))["offset"];
    }
    /*
    Get an article matching the search criteria
    */
    this.getArticles = function()  {
    	var listEntries = JSON.parse(this.getResult('Response'))["results"];
    	var resultArray = new Array();
    	if(listEntries != null) {
    		for(var i=0; i < listEntries.length; i++) {
    			resultArray[i] = new  NYTimesArticle(listEntries[i]);
    		}
    	}
    	return resultArray;
    }
    ...
    */
    this.getTokens = function()  {
    	var listEntries = JSON.parse(this.getResult('Response'))["tokens"];
    	var resultArray = new Array();
    	if(listEntries != null) {
    		for(var i=0; i < listEntries.length; i++) {
    ...
    */
    this.getTotal = function()  {
    	return JSON.parse(this.getResult('Response'))["total"];
    }
}
...
var NYTimesArticle = function(base) {
	var base = base;
