...
function program9(depth0,data) {
  ...
  hashTypes = {};
  hashContexts = {};
  stack2 = helpers['if'].call(depth0, "user", {hash:{},inverse:self.program(8, program8, data),fn:self.program(5, program5, data),contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("\n			</ul>\n		</div>\n	</nav>\n	");
  hashTypes = {};
  hashContexts = {};
...
function program3(depth0,data) {
  ...
  data.buffer.push(">\n				<input type=\"submit\" value=\"Sign on with Google\" class=\"btn btn-primary pull-right\">\n			</form>\n		</div>\n	</div>\n");
  return buffer;
  }
